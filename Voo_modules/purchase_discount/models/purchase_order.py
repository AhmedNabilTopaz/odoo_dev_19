...
class PurchaseOrderLine(models.Model):
    ...
    def _prepare_purchase_order_line(
        ...
        # In Odoo 17+, supplier is already a res.partner
        partner = supplier if supplier._name == 'res.partner' else supplier.partner_id

        # uom_po_id no longer exists in Odoo 19 — use product_uom directly
